...
## Q4. carrier 변수는 항공사 코드(carrier codes)를 담고 있습니다. 어떤 항공사의 운항이 많았는지 알아보려고 합니다. 항공사별 '운항 빈도'를 출력하세요.
...
## Q6. 어떤 항공사의 '점유율'이 높았는지 알아보려고 합니다. 항공사별 점유율을 출력하세요(힌트 : 점유율 = 전체 빈도에서 해당 구성 요소의 빈도가 차지하는 비율).
