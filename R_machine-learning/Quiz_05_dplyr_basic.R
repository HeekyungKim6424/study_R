...
# 3-1. hour 변수는 항공편이 몇 시에 출발했는지, 출발 시각을 담고 있습니다. 항공편이 오전(AM)과 오후(PM)에 각각 몇 편 출발했는지 알아보세요.
...
# 3-3. 오전에 출발하는 항공편이 어떤 공항으로 많이 가는지 알아보려고 합니다. 오전 출발 항공편의 목적지별 빈도와 점유율을 출력하세요. 상위 5개 목적지만 출력되게 설정하세요.
